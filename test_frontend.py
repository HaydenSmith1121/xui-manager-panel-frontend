...
class FrontendTests(unittest.TestCase):
    ...
    def test_ticket_help_page_keeps_scroll_inside_panels(self):
        ...
        self.assertIn("data-new-ticket", index_html)
        self.assertNotIn("像聊天软件一样处理问题", index_html)
        self.assertNotIn("admin-conversation-list", index_html)
        self.assertNotIn("工单会话", index_html)
        self.assertIn("renderTicketConversationPane", app_js)
        self.assertIn("ticketCreateFormHtml", app_js)
        self.assertIn("isCreatingTicket", app_js)
        self.assertIn("state.isCreatingTicket = !state.isCreatingTicket", app_js)
        self.assertIn("收起新建", app_js)
        self.assertIn("data-delete-user-ticket", app_js)
        self.assertIn("data-delete-admin-ticket", app_js)
        self.assertIn("/api/tickets/delete", app_js)
        self.assertIn("/api/admin/tickets/delete", app_js)
        ...
        self.assertIn("body.is-authed #ticketsView .user-only.hidden", app_css)
        self.assertIn("body.is-authed #ticketsView .ticket-new-button", app_css)
        self.assertIn("body.is-authed #ticketsView .ticket-new-button.active", app_css)
        self.assertIn("body.is-authed #ticketsView .ticket-delete-button", app_css)
        self.assertIn("width: min(760px, calc(100% - 56px))", app_css)
        self.assertIn("min-height: 220px", app_css)
